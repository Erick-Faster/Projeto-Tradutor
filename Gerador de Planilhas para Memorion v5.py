...
def pressionaBotao(*args):
    teste.set("Processando")
    root.destroy()
    

def Verificador(nomeBase):   
...
ttk.Button(mainframe, text="OK", command=pressionaBotao).grid(column=2, row=4, sticky=E)
...
root.bind('<Return>', pressionaBotao) #Ativa 'Enter' para o botao
root.resizable(0, 0) #Impede que janela seja extendida
